  ...
  .controller('MainCtrl', function ($scope, $http, $routeParams, $window, $sce) {
    ...
    $http.get('Row1data.json').success (function(data){
      ...
      $scope.item = data[param1];
        ...
        return $sce.trustAsResourceUrl("http://instagram.com/p/"+id+"/embed?hidecaption=true");
      }
      ...
      $scope.urlImage = "images/"+ data[param1].establishement_name_id + '.jpg'; //"images/"+ data[param1].establishement_id + '.jpg';
      console.log(data[param1].establishement_name_id);
